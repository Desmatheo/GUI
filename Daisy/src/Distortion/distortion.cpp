...
daisysp::Highpass preFilter(preFilterCutoffBase, 48000); // Dummy values that get overwritten in Init
daisysp::Tone postFilter(postFilterCutoff, 48000);    // Dummy values that get overwritten in Init
daisysp::Tone upsamplingLowpassFilter(0.0f, 48000);   // Dummy values that get overwritten in Init
